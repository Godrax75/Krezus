...
/// une identité. Le mode est fixé à « papier » à la sortie : c'est le seul
/// ouvert en v1, et une page de choix entre une option disponible et une
/// option verrouillée ne demandait rien à personne. Les illustrations du prototype ne sont pas encore embarquées
...
struct OnboardingScreen: View {
    ...
    private var footer: some View {
        VStack(spacing: KrezusSpacing.s3) {
            KrzPrimaryButton(title: page < Self.lastPage ? t("common.continue") : t("onboarding.start")) {
                if page < Self.lastPage {
