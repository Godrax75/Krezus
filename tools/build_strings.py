...
add({
    ...
    "common.live":      ("En direct", "Live"),
    "quote.minutes_ago": ("il y a %d min", "%d min ago"),
    "quote.hours_ago":   ("il y a %d h", "%dh ago"),
    "a11y.quote_age":    ("Cours %@", "Quote %@"),
...
add({
    ...
    "sector.utilities":  ("Services aux collectivités", "Utilities"),
    "sector.energy":      ("Énergie & pétrole", "Energy & oil"),
...
add({
    ...
    "arena.performance_title": ("Classement", "Leaderboard"),
    "arena.disclaimer": (
...
add({
    ...
    # Arena : classement par période et recherche (0020).
    "arena.scope.global":  ("Général", "Everyone"),
    "arena.scope.friends": ("Amis", "Friends"),
    "arena.period.day":    ("Jour", "Day"),
    "arena.period.week":   ("Semaine", "Week"),
    "arena.period.month":  ("Mois", "Month"),
    "arena.period.ytd":    ("YTD", "YTD"),
    "arena.period.all":    ("Tout", "All"),
    "arena.period_subtitle.day":   ("Performance depuis la clôture d'hier.",
                                    "Performance since yesterday's close."),
    "arena.period_subtitle.week":  ("Performance depuis la clôture de vendredi dernier.",
                                    "Performance since last Friday's close."),
    "arena.period_subtitle.month": ("Performance depuis le début du mois.",
                                    "Performance since the start of the month."),
    "arena.period_subtitle.ytd":   ("Performance depuis le 1er janvier.",
                                    "Performance since January 1st."),
    "arena.period_subtitle.all":   ("Performance depuis tes débuts, sur 1 000 € de départ.",
                                    "Performance since you started, from a €1,000 start."),
    "arena.ranking.empty_global":  ("Personne n'a encore passé d'ordre. Sois le premier au classement !",
                                    "Nobody has placed an order yet. Be the first on the board!"),
    "arena.ranking.empty_friends": ("Ajoute des amis depuis l'onglet Amis pour te mesurer à eux.",
                                    "Add friends from the Friends tab to compete with them."),
    "arena.search.placeholder": ("Rechercher un joueur", "Search for a player"),
    "arena.search.clear":       ("Effacer la recherche", "Clear search"),
    "arena.search.no_result":   ("Aucun joueur avec ce pseudo.", "No player with that username."),
    "arena.search.add":         ("Ajouter", "Add"),
    "arena.search.sent":        ("Envoyée", "Sent"),
    "arena.search.accept":      ("Accepter", "Accept"),
    "arena.search.friend":      ("Ami", "Friend"),
    "arena.toast.request_sent": ("Demande envoyée à %@", "Request sent to %@"),
